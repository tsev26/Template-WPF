...
namespace Template_WPF.ViewModels
{
    public class SecondViewModel : ViewModelBase
    {
        ...
        public SecondViewModel(INavigationService navigateHomeService, MessageStore messageStore)
        {
            NavigateHomeViewCommand = new NavigateCommand(navigateHomeService);
